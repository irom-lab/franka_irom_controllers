...
#include <franka_irom_controllers/cartesian_velocity_node_controller.h>
...
bool CartesianVelocityNodeController::init(hardware_interface::RobotHW* robot_hardware,
  ...
  velocity_command_subscriber = node_handle.subscribe("/cartesian_velocity_node_controller/cartesian_velocity",
                                                       10,
...
PLUGINLIB_EXPORT_CLASS(franka_irom_controllers::CartesianVelocityNodeController,
